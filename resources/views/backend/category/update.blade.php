                    ...
                    <div class="form-body">
                        <div class="form-group row @error('title') is-invalid @enderror">
                            ...
                            <div class="col-md-5">
                                ...
                                @error('title') is-invalid @enderror" value="{{ old('title',$category->title) }}">
                        ...
                        <div class="form-group row @error('title') has-error @enderror">
                            ...
                            <div class="col-md-8">
                                <textarea name="description" id="description"
                                    class="form-control
                                    @error('description') is-invalid @enderror">{{ old('description',$category->description) }}</textarea>
                            ...
                            <div class="col-md-3">
                                <select name="status" id="status"
                                    ...
                                    <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}
                                        {{ $category->status == 'active' ? 'selected' : ''}}>Aktif</option>
                                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}
                                        {{ $category->status == 'inactive' ? 'selected' : '' }}>Tidak Aktif
                                    </option>
                                </select>
